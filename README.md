...
Rispetto alla vecchia versione [1.0](https://github.com/Lod34/Sensore-porta-Arduino/README.md#L212), l'unica differenza è che al posto di utilizzare il pulsante come accensione del sensore, utilizzeremo un sensore a infrarossi.
